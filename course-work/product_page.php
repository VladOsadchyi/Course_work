...
<div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="shop.php">Магазин</a> <!-- Посилання на сторінку магазину -->
        ...
        <div class="product-container">
            <?php include 'php_for_work/product_details.php'; ?>
        </div>
        <button class="order-button" onclick="window.location.href = 'order_form.php?product_name=<?php echo urlencode($row['name']); ?>';">Замовити</button>
</body>
</html>
